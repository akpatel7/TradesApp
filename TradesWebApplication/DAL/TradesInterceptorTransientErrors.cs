...
{
    public class TradesInterceptorTransientErrors : DbCommandInterceptor
    {
        ...
        private SqlException CreateDummySqlException()
        {
            ...
            var sqlExceptionCtor =
                typeof (SqlException).GetConstructors(BindingFlags.Instance | BindingFlags.NonPublic)
                    ...
                    .Single();
            var sqlException =
                (SqlException) sqlExceptionCtor.Invoke(new object[] {"Dummy", errorCollection, null, Guid.NewGuid()});
