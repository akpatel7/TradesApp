...
namespace TradesWebApplication.Controllers
{
    public class TradesController : Controller
    {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult TradesCreation()
        {
            return View("TradesCreation");
        }
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult TradesList()
        {
            return View("TradesList");
        }
        ...
        public ActionResult StartTradeEntry(string tradeID = "")
        {
            ...
            //var tradesViewModel = null;//tradesApplicationService.BeginTradeEntry(tradeID);
        ...
        public ActionResult UpdateTrade(FormCollection postedFormData)
        {
            ...
            return Json(new
            {
                ...
                MessageBoxView = Helpers.MvcHelpers.RenderPartialView(this, "_MessageBox", null),
            });
