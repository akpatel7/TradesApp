...
function TradeViewModel(
  ...
  status
    ...
    this.instruction_entry_date = ko.validatedObservable(instruction_entry_date).extend({ required: { params: true, showMessages: false }, dateISO: { params: true, insertMessages: false } });
